...
5) Database is ready to use sqlite database.sqlite file located in the database folder.
...
If You want fresh database, you can run 
...
Multytenansy is implemented according to the following guide:
...
If you fresh database, with seeder, You can access Filament panel 
using the credentials from part "How to access Filament panels".
